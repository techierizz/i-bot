...
def evaluate_interview(context: dict, chat_history: list) -> dict:
    ...
    try:
        ...
        if user_turns < question_limit:
            ...
            parsed_response["feedback"]["overall_summary"] = "Interview ended before completion. Evaluation unavailable, but ATS Resume Optimization has been provided in the resume hub in main page, based on your resume."
