...
async def scrape_verification_url(url: str) -> str:
...
async def verify_certificate_online(url: str, candidate_name: str, company: str, role: str) -> dict:
    try:
        scraped_text = await scrape_verification_url(url)
